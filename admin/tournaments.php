      ...
      <table class="admin-table table-tournaments">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <?php if ($t['banner']): ?>
                <img src="../../uploads_v4d/banners/<?= sanitize($t['banner']) ?>" class="admin-banner-thumb">
              <?php else: ?>
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <?php if (!empty($edit_t['banner'])): ?>
            <img src="../../uploads_v4d/banners/<?= sanitize($edit_t['banner']) ?>" class="upload-preview-cover" id="banner-preview">
          <?php else: ?>
