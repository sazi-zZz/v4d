...
if ($action === 'edit' && $edit_id) {
    ...
    $s->execute([$edit_id]);
    $edit_t = $s->fetch();
    if (!$edit_t) redirect('/v4d/admin/tournaments.php');
...
<div class="admin-layout">
  ...
  <main class="admin-main">
    <div class="admin-topbar">
      ...
      <?php else: ?>
        <a href="/v4d/admin/tournaments.php" class="btn btn-outline btn-sm">← Back</a>
      <?php endif; ?>
    </div>
      ...
      <table class="admin-table">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <?php if ($t['banner']): ?>
                <img src="/v4d/uploads/banners/<?= sanitize($t['banner']) ?>" class="admin-banner-thumb">
              <?php else: ?>
    ...
    <?php else: ?>
    <!-- Add / Edit Form -->
    <form class="admin-form" method="POST" action="/v4d/api/save_tournament.php" enctype="multipart/form-data" id="tournament-form">
      <?php if ($edit_t): ?>
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <?php if (!empty($edit_t['banner'])): ?>
            <img src="/v4d/uploads/banners/<?= sanitize($edit_t['banner']) ?>" class="upload-preview-cover" id="banner-preview">
          <?php else: ?>
      ...
      <div class="admin-form-actions">
        ...
        <a href="/v4d/admin/tournaments.php" class="btn btn-outline">Cancel</a>
      </div>
    </form>
    <?php endif; ?>
...
<div class="modal-overlay" id="delete-modal" style="display:none;">
  <div class="modal-box">
    ...
    <div class="modal-actions">
      <form method="POST" action="/v4d/api/delete_tournament.php">
