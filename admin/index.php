...
<div class="admin-layout">
  ...
  <main class="admin-main">
    <div class="admin-topbar">
      ...
      <span class="admin-greeting">Welcome, <strong><?= sanitize($_SESSION['admin_user']) ?></strong></span>
    </div>
    ...
    <div class="dash-stats">
      <div class="dash-stat-card">
        ...
        <div class="dash-stat-value"><?= $total_players ?></div>
        <div class="dash-stat-label">Players</div>
      </div>
      <div class="dash-stat-card">
        <div class="dash-stat-icon">🏆</div>
        <div class="dash-stat-value"><?= $total_tournaments ?></div>
        <div class="dash-stat-label">Tournaments</div>
      </div>
      <div class="dash-stat-card">
        <div class="dash-stat-icon">⚡</div>
        <div class="dash-stat-value"><?= $total_wins ?></div>
        <div class="dash-stat-label">Total Wins</div>
      </div>
      <div class="dash-stat-card">
        <div class="dash-stat-icon">👑</div>
        <div class="dash-stat-value" style="font-size:1rem"><?= $top_player ? sanitize($top_player) : '—' ?></div>
