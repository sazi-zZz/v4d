  ...
  endforeach; ?>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <img src="/v4d/uploads/profiles/<?= sanitize($edit_player['profile_pic'])?>" class="upload-preview-img"
          ...
          <div class="form-group">
            ...
            <img src="/v4d/uploads/covers/<?= sanitize($edit_player['cover_image'])?>" class="upload-preview-cover"
