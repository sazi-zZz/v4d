...
<div class="tournament-hero">
  <?php if ($tournament['banner']): ?>
    <img src="/v4d/uploads/banners/<?= sanitize($tournament['banner']) ?>" alt="<?= sanitize($tournament['name']) ?>" class="tournament-hero-img">
  <?php else: ?>
    <div class="tournament-hero-placeholder"></div>
  <?php endif; ?>
  <div class="tournament-hero-overlay">
    <div class="container">
      <a href="/v4d/tournaments.php" class="back-link">← Back to Tournaments</a>
    ...
    <div class="tournament-layout">
      ...
      <div class="tournament-stats-section" data-anim>
        ...
        <div class="t-stats-grid">
          ...
          <a href="/v4d/player.php?id=<?= $p['id'] ?>" class="t-stat-card glass-card">
            <span class="rank-badge rank-<?= $r <= 3 ? $r : 'other' ?>">#<?= $r ?></span>
            <div class="t-stat-player">
              <?php if ($p['profile_pic']): ?>
                <img src="/v4d/uploads/profiles/<?= sanitize($p['profile_pic']) ?>" alt="" class="t-stat-avatar" style="border-color:<?= sanitize($p['border_color']) ?>">
              <?php else: ?>
