...
<main class="main-content">
  <div class="container">
    ...
    <div class="grid-3">
      ...
      <a href="/v4d/tournament.php?id=<?= $t['id'] ?>" class="tournament-card" data-anim>
        <?php if ($t['banner']): ?>
          <img src="/v4d/uploads/banners/<?= sanitize($t['banner']) ?>" alt="<?= sanitize($t['name']) ?>" class="tournament-card-banner" loading="lazy">
        <?php else: ?>
